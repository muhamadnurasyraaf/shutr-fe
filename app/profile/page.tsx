...
export default function PhotographerProfile() {
  ...
  const handleCompleteProfile = () => {
    ...
    // State will be properly initialized on next visit from localStorage
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      {/* Toast Notification */}
      {toast.show && (
        <div className="fixed top-4 right-4 z-50 bg-cyan-400 text-black px-6 py-3 rounded-lg shadow-lg animate-slide-in">
          {toast.message}
        </div>
      )}
    ...
    <Header/>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex gap-8 items-start">
          ...
          <div className="w-64 flex-shrink-0 bg-white rounded-lg shadow-sm border border-gray-200 p-6 sticky top-8">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden animate-fade-in">
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          IC/ID Number <span className="text-red-500">*</span>
                        </label>
                        <input
                          type="text"
                          required
                          value={personalInfo.icNumber}
                          onChange={(e) => handlePersonalChange("icNumber", e.target.value)}
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-transparent"
                        />
                      </div>
